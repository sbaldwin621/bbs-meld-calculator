...
export enum Command {
  // Attack
  QuickBlitz = 'QuickBlitz',
  Blitz = 'Blitz',
  MeteorCrash = 'MeteorCrash',
  MagicHour = 'MagicHour',
  SlidingDash = 'SlidingDash',
  FireDash = 'FireDash',
  DarkHaze = 'DarkHaze',
  SonicBlade = 'SonicBlade',
  ChaosBlade = 'ChaosBlade',
  Zantetsuken = 'Zantetsuken',
  StrikeRaid = 'StrikeRaid',
  FreezeRaid = 'FreezeRaid',
  TreasureRaid = 'TreasureRaid',
  SparkRaid = 'SparkRaid',
  WindRaid = 'WindRaid',
  FireSurge = 'FireSurge',
  BarrierSurge = 'BarrierSurge',
  ThunderSurge = 'ThunderSurge',
  AerialSlam = 'AerialSlam',
  ArsSolum = 'ArsSolum',
  ArsArcanum = 'ArsArcanum',
  TimeSplicer = 'TimeSplicer',
  PoisonEdge = 'PoisonEdge',
  WishingEdge = 'WishingEdge',
  BlizzardEdge = 'BlizzardEdge',
  StunEdge = 'StunEdge',
  SlotEdge = 'SlotEdge',
  FireStrike = 'FireStrike',
  ConfusionStrike = 'ConfusionStrike',
  BindingStrike = 'BindingStrike',
  TornadoStrike = 'TornadoStrike',
  BrutalBlast = 'BrutalBlast',
  MagnetSpiral = 'MagnetSpiral',
  Salvation = 'Salvation',
  Windcutter = 'Windcutter',
  LimitStorm = 'LimitStorm',
  CollisionMagnet = 'CollisionMagnet',
  GeoImpact = 'GeoImpact',
  Sacrifice = 'Sacrifice',
  BreakTime = 'BreakTime',
  ...
  Fira = 'Fira',
  Firaga = 'Firaga',
  DarkFiraga = 'DarkFiraga',
  FissionFiraga = 'FissionFiraga',
  CrawlingFire = 'CrawlingFire',
  TripleFiraga = 'TripleFiraga',
  Blizzard = 'Blizzard',
  Blizzara = 'Blizzara',
  Blizzaga = 'Blizzaga',
  TripleBlizzaga = 'TripleBlizzaga',
  Thunder = 'Thunder',
  Thundara = 'Thundara',
  Thundaga = 'Thundaga',
  ThundagaShot = 'ThundagaShot',
  Cure = 'Cure',
  Cura = 'Cura',
  Curaga = 'Curaga',
  Esuna = 'Esuna',
  ...
  ZeroGravira = 'ZeroGravira',
  ZeroGraviga = 'ZeroGraviga',
  Magnet = 'Magnet',
  Magnera = 'Magnera',
  Magnega = 'Magnega',
  MunnyMagnet = 'MunnyMagnet',
  EnergyMagnet = 'EnergyMagnet',
  DLinkMagnet = 'DLinkMagnet',
  Aero = 'Aero',
  Aerora = 'Aerora',
  Aeroga = 'Aeroga',
  Faith = 'Faith',
  ...
  Stopga = 'Stopga',
  Sleep = 'Sleep',
  WrathOfDarkness = 'WrathOfDarkness',
  ...
  FireGlide = 'FireGlide',
  SonicImpact = 'SonicImpact',
  Slide = 'Slide',
  HomingSlide = 'HomingSlide',
  Teleport = 'Teleport',
  ...
  StunBlock = 'StunBlock',
  PoisonBlock = 'PoisonBlock',
  Barrier = 'Barrier',
  RenewalBarrier = 'RenewalBarrier',
  FocusBarrier = 'FocusBarrier',
  ConfuseBarrier = 'ConfuseBarrier',
  StopBarrier = 'StopBarrier',

  // Reprisal
  CounterRush = 'CounterRush',
  ReversalSlash = 'ReversalSlash',
  PaybackRaid = 'PaybackRaid',
  CounterHammer = 'CounterHammer',
  PaybackFang = 'PaybackFang',
  CounterBlast = 'CounterBlast',
  PaybackSurge = 'PaybackSurge',
  AerialRecovery = 'AerialRecovery',

  // Shotlock
  LightningRay = 'LightningRay',
  MeteorShower = 'MeteorShower',
  BioBarrage = 'BioBarrage'
}
